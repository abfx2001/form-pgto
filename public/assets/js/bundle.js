...
/* harmony export */   "default": () => (/* binding */ autocoplet)
/* harmony export */ });
...
function autocoplet() {
  var inputEl = document.querySelector('#autocompleteInput');
  inputEl.addEventListener('input', onInputChange);
  testeArray();
  var idBancos = [];
  function testeArray() {
    return _testeArray.apply(this, arguments);
  }
  function _testeArray() {
    _testeArray = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var res, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            data = _context.sent;
            idBancos = data.map(function (bancos) {
              return bancos.id;
            });
          case 7:
          case "end":
  ...
  function onInputChange() {
    ...
    var bancosFiltrados = [];
    bancosFiltrados = idBancos.filter(function (x) {
  ...
  function createAutocompleteDropdown(list) {
    ...
    list.forEach(function (banco) {
      var listItem = document.createElement("li");
      var bancoBotao = document.createElement("button");
  ...
  function removeAutocompleteDropdown() {
    var listEl = document.querySelector("#autocompleteList");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ imprimirTela)
/* harmony export */ });
function imprimirTela() {
  var controle = true; // controle do forms
  if (controle) {
...
function inputMask() {
  ...
  var inputValorMoeda = document.querySelector('#inputValorMoeda');
  inputValorMoeda.addEventListener('keyup', function () {
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var selectPag = document.getElementById('formaDePagamento');
var chavePix = document.getElementById('chavePix');
var linhaPix = document.getElementById('linhaPix');
function selecTipoPag() {
  selectPag.addEventListener('change', function () {
    ...
    if (selectPag.value === 'pixCpf') {
      var mascaraMutuario = function mascaraMutuario(o, f) {
        var v_obj = o;
        var v_fun = f;
        setTimeout(function () {
          v_obj.value = v_fun(v_obj.value);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ timeStampNow)
/* harmony export */ });
function timeStampNow() {
  ...
  var interval = setInterval(function () {
    var now = new Date();
    var dataHora = zeroFill(now.getUTCDate()) + '/' + zeroFill(now.getMonth() + 1) + '/' + now.getFullYear() + ' ' + zeroFill(now.getHours()) + ':' + zeroFill(now.getMinutes()) + ':' + zeroFill(now.getSeconds());
...
/* harmony import */ var _modules_seletorPix__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/seletorPix */ "./src/modules/seletorPix.js");
